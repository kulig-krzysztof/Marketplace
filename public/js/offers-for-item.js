...
fetch("/offersOfBidder", {
    ...
    placeCounterOfferMarkers(offersOfBidder);
});
                ...
                new mapboxgl.Popup({ offset: 25 }) // add popups
                    .setHTML(
                        `<h3 class="popup-h3">Autor:</h3><p class="popup-p" id="p-email">${feature.email}</p><h3 class="popup-h3">Cena:</h3><p id="p-price" class="popup-p">${feature.price} zł</p><h3 class="popup-h3">Data i godzina:</h3><p id="p-data" class="popup-p">${feature.data}</p><h3 class="popup-h3">Miasto:</h3><p id="p-city" class="popup-p">${feature.city_name}</p><p id="p-lng">${feature.coordinates[0]}</p><p id="p-lat">${feature.coordinates[1]}</p><p hidden id="p-id" class="popup-p">${feature.id}</p>
                         ...
                         <!-- <form method="post" action="respondToOffer"><input type="hidden" name="id" value="${feature.id}"><input id="#add" class="offer-button" type="submit" name="respond" value="Respond"></form> -->
...
function placeCounterOfferMarkers(offersOfBidder) {
